...
//                    finish();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent intent = new Intent(getApplicationContext(), HeartRateSettingsActivity.class);
            ...
            Intent intent1 = new Intent(getApplicationContext(), MyHeartSensorService.class);
